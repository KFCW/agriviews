    ...
    <>
      <div className="sider__container" style={styles.sider__container}>
        <div style={styles.logo_container}>
          <Link to="/productor/dash" style={styles.links} className="side__logo">AgriDigital</Link>
          <hr className="hr" style={styles.hr} />
        </div>
        <MenuItem to="/productor/dash" icon={<MdSpaceDashboard />} label="Dashbord" isActive={activeLink === '/admin/dash'} onClick={() => handleLinkClick('/admin/dash')} />
        <MenuItem to="gain" icon={<IoCard />} label="Soldes" isActive={activeLink === '/gain'} onClick={() => handleLinkClick('/gain')} />
        <MenuItem to="client" icon={<FaUserTag />} label="Clients" isActive={activeLink === '/client'} onClick={() => handleLinkClick('/client')} />
        ...
        <MenuItem to="feedback" icon={<VscFeedback />} label="Feedbacks" isActive={activeLink === '/feedback'} onClick={() => handleLinkClick('/feedback')} />
